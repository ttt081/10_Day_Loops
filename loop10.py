...
count_lang = []
for lg in lang_set:
    count_lang.append((lang_lst.count(lg), lg))

count_lang.sort(reverse=True)

for cnt, lg in count_lang[:10]:
    print(f"{cnt:<5} {lg}")

# Find the 10 most populated countries in the world
population_lst = []
for dct in country_data:
    population_lst.append((dct["population"], dct["name"]))

population_lst.sort(reverse=True)

print()
for n, country_name in population_lst[:10]:
    print(f"{n:<20}{country_name:<10}")
